...
import { addCompanyGoal, addKeyResult, getState, addFeasibilityCase, updateFeasibilityCase, addStakeholder, addProject, addMilestone, addTask, addPrediction } from "./store.js";
...
export function seedExample() {
  ...
  addTask({ title: "완료율 원인 3가지로 압축", projectId: pid, status: "doing", priority: "high" });
  addTask({ title: "결제사 PM 미팅 주선", projectId: pid, status: "todo", priority: "med" });
  addTask({ title: "(Inbox 예시) 경쟁사 결제 UX 스캔", inbox: true, priority: "low" });
